...
Sub ShowStyleList()
	...
	Do While Not oRs.Eof
		...
		Else
			sManage = sManage & "|<a href='?action=styledel&id=" & oRs("S_ID") & "' onClick=""return confirm('确定删除？');"">删除</a>"
		End If
...
Sub ShowToolBarList()
	...
	Do While Not oRs.Eof
		...
		If nStyleIsSys <> 1 Then
			s_Manage = s_Manage & "|<a href='?id=" & sStyleID & "&action=toolbardel&delid=" & oRs("t_id") & "' onClick=""return confirm('确定删除？');"">删除</a>"
		End If
