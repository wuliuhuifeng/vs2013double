...
<asp:GridView ID=gridview1 runat=server AutoGenerateColumns=false Width=100% 
    ...
    <ItemTemplate><asp:TextBox ID=name runat=server Text='<%# Eval("name") %>' Width=60px></asp:TextBox></ItemTemplate>
    ...
    <asp:TemplateField HeaderText="见点奖">
    <ItemTemplate><asp:TextBox ID=point runat=server Text='<%# Eval("point") %>' Width=50px></asp:TextBox>%</ItemTemplate>
    <ItemStyle Width=12%  HorizontalAlign=Center />
    </asp:TemplateField>
    ...
    <asp:TemplateField HeaderText="快速推荐奖">
    <ItemTemplate><asp:TextBox ID=rapidAward runat=server Text='<%# Eval("rapidAward") %>' Width=50px></asp:TextBox>元/周</ItemTemplate>
    <ItemStyle Width=12% HorizontalAlign=Center />
    </asp:TemplateField>
...
<table cellspacing="0" rules="all" border="1" id="gridview1" style="width:100%;border-collapse:collapse;">
	<tr>
		...
		<td align="center" style="width:12%;"><asp:TextBox ID=money runat=server Width=70px></asp:TextBox>元</td>
		<td align="center" style="width:12%;"><asp:TextBox ID=point runat=server Width=70px></asp:TextBox>单</td>
