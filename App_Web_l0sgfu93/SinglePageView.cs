...
public class SinglePageView : Page, IRequiresSessionState
{
	...
	public void BindData()
	{
		...
		{
			sQL = "select B.sortName as sortName,B.moduleId as moduleId, A.* from SinglePage as A,infoSort as B where A.sortId=B.id and A.sortId=" + int.Parse(base.Request["sortId"]);
		}
		if (base.Request["id"] != null)
		{
			sQL = "select B.sortName as sortName,B.moduleId as moduleId, A.* from SinglePage as A,infoSort as B where A.sortId=B.id and A.Id=" + int.Parse(base.Request["Id"]);
		}
